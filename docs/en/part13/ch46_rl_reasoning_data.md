...
## Abstract
The previous chapter discussed supervised fine-tuning (SFT), preference alignment, reward models, and reinforcement learning with verifiable rewards (RLVR) data interfaces in the post-training stage. This chapter moves further forward, focusing on the most significant shift in the open-source community since 2025: reasoning models no longer rely solely on manually written long chain-of-thought samples. Instead, they actively expand their reasoning trajectory space through reinforcement learning (RL) and verifiable rewards.
...
*Figure 46-1: Data feedback relationships in reasoning-model training*

The feedback path links cold-start SFT, large-scale RL, rejection sampling, and second-round SFT.
...
Figure 46-3 shows these three trajectory patterns in a Long-CoT sample cross-section.

![Figure 46-3: Long-CoT data sample cross-section](../../images/part13/Xu-Chap46-Fig03.svg)
*Figure 46-3: Long-CoT data sample cross-section*
