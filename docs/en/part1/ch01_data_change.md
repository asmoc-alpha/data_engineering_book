...
| **Compliance awareness** | Basic General Data Protection Regulation (GDPR) de-identification requirements | Requires copyright law knowledge, personally identifiable information (PII) detection capability based on named entity recognition (NER) and regular expressions, and compliance with robots.txt conventions |
