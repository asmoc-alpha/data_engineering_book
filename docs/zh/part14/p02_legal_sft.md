...
代码清单P02-1 给出了流程或路径示例，用于说明本节中的输入输出关系、结构约束或执行方式。
```text
...
边界写清楚需要重点关注。因为一个工程项目通常只有两种展开方式：
...
![图 P02-1：法律领域 SFT 数据工厂总览](../../images/part14/p02/Xu-Project02-Fig01.svg)
...
负责制定审核协议、抽检规则、返工机制、错误标签和升级路径。在法律场景里，这个角色关键，因为项目最终是否可用，并不取决于模型生成过多少样本，而取决于错误样本有没有被识别并挡在外面。
...
![图 P02-2：法律 SFT 数据工厂角色分工图](../../images/part14/p02/Xu-Project02-Fig02.svg)
...
代码清单P02-2 给出了 Python 实现片段，用于说明本节中的输入输出关系、结构约束或执行方式。
```python
...
代码清单P02-3 给出了流程或路径示例，用于说明本节中的输入输出关系、结构约束或执行方式。
```text
……应当依法承担相应责任。 - 195 - 当事人……
```
...
这类清洗看起来像“胶水代码”，但在工程里往往关键。因为它决定的是：
...
代码清单P02-4 给出了流程或路径示例，用于说明本节中的输入输出关系、结构约束或执行方式。
```text
法 律 规 定
合 同 关 系
```
...
![图 P02-3：法律 PDF 智能清洗示意图](../../images/part14/p02/Xu-Project02-Fig03.svg)
*图 P02-3：法律 PDF 智能清洗示意图*

图P02-4展示了相应的流程或结构。

![图 P02-4：嵌入式页码与中文断词修复案例](../../images/part14/p02/Xu-Project02-Fig04.svg)
...
![图 P02-5：法律种子样本 schema 示意图](../../images/part14/p02/Xu-Project02-Fig05.svg)
...
![图 P02-6：法律任务体系分层图](../../images/part14/p02/Xu-Project02-Fig06.svg)
*图 P02-6：法律任务体系分层图*
...
![图 P02-7：任务分布与法域覆盖对照图](../../images/part14/p02/Xu-Project02-Fig07.svg)
...
![图 P02-8：加权轮盘赌任务采样示意图](../../images/part14/p02/Xu-Project02-Fig08.svg)
...
![图 P02-9：案情分析类 CoT 结构示意图](../../images/part14/p02/Xu-Project02-Fig09.svg)
...
![图 P02-10：偏好对与评审记录关系图](../../images/part14/p02/Xu-Project02-Fig10.svg)
...
![图 P02-11：法律场景风险拒答分流图](../../images/part14/p02/Xu-Project02-Fig11.svg)
...
![图 P02-12：QA 审核闭环图](../../images/part14/p02/Xu-Project02-Fig12.svg)
*图 P02-12：QA 审核闭环图*

图P02-13展示了相应的流程或结构。

![图 P02-13：QA 接收/返工/拒收判定表](../../images/part14/p02/Xu-Project02-Fig13.svg)
...
![图 P02-14：人机协同与供应商分层审核图](../../images/part14/p02/Xu-Project02-Fig14.svg)
...
![图 P02-15：训练封装与交付接口图](../../images/part14/p02/Xu-Project02-Fig15.svg)
*图 P02-15：训练封装与交付接口图*
...
![图 P02-16：P02 核心指标总览图](../../images/part14/p02/Xu-Project02-Fig16.svg)
...
第二，在法律场景中关键的两个目标——**保留法条依据**与**避免武断捷径表达**——在 `chosen/rejected` 之间表现出显著差异。
...
这一步已经需要重点关注。因为很多数据工程项目最大的问题就是只讲构造流程，不讲任何后验验证，最后很难判断产出的数据是否真的有效。
...
![图 P02-17：50 条抽样验证流程图](../../images/part14/p02/Xu-Project02-Fig17.svg)
...
它能较直观地说明：数据工厂不是一下子长成的；每一版都有自己的核心目标；不是所有问题都应该在第一版解决；版本升级的触发条件，应该来自真实问题，而不是抽象完美主义。

图P02-18展示了相应的流程或结构。

![图 P02-18：P02 版本演进路线图](../../images/part14/p02/Xu-Project02-Fig18.svg)
...
当前项目的人审工时已经达到 193.28 小时，这个数字本身就是一个较好的提醒：行业数据工厂从来不是“模型多跑一点”的问题，而是“人机协同如何不失控”的问题。
...
因为它体现了一种需要重点关注的工程习惯：数据项目的完成标准，不是“生成了大量文件”，而是“代码、产物、统计与报告彼此一致”。

图P02-19展示了相应的流程或结构。

![图 P02-19：代码—产物—报告一致性验证图](../../images/part14/p02/Xu-Project02-Fig19.svg)
...
法律并不是唯一需要垂直领域 SFT 的行业，但它是一个较好的样板。原因在于，法律场景同时具备以下特征：
...
![图 P02-20：行业迁移方法链图](../../images/part14/p02/Xu-Project02-Fig20.svg)
*图 P02-20：行业迁移方法链图*
