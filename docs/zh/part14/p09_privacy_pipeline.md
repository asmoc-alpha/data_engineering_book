...
这一点关键，因为隐私控制里最昂贵的错误，往往不是“掩码没写完整”，而是“根本不该看到原始数据的人先看到了”。
...
隐私治理里，一个高频但又经常被低估的问题是：哪怕你做了去标识化，如果原始记录与处理结果仍然混放在同一逻辑区，很多风险依然存在。
...
因为很多团队真正缺的，不是“知道要做验证”，而是不知道要把验证写成什么样。P09 给出了一个适合作为模板的最小做法：
...
从规模上看，P09 较为克制：只有 8 条原始记录，远谈不上生产级数据量。它仍然值得单独展开，是因为它呈现出了强烈的“闭环感”。
