...
表31-1汇总了本节的关键对象、工程要点与复核口径。

*表 31-1：数据工程高频任务的 Agent 化收益与风险评估*
...
图31-1展示了本节讨论对象的结构、流程或样例，便于对照正文理解关键环节。

*图 31-1：数据工程 Agent 六层架构图*

六层组件的职责边界如下表所示：

表31-2汇总了本节的关键对象、工程要点与复核口径。

*表 31-2：六层组件的职责边界与故障模式*
...
表31-3汇总了本节的关键对象、工程要点与复核口径。

*表 31-3：Agent 工具注册表示例*
...
表31-5汇总了本节的关键对象、工程要点与复核口径。

*表 31-5：DataAgent 与六层架构的对应关系*
...
图31-2展示了本节讨论对象的结构、流程或样例，便于对照正文理解关键环节。

*图 31-2：人机协同流程图——按风险等级分流*
...
表31-8汇总了本节的关键对象、工程要点与复核口径。

*表 31-8：DataAgent 语义问数 MVP 的配置门禁*
...
表31-10汇总了本节的关键对象、工程要点与复核口径。

*表 31-10：Agent 能力成熟度模型*
