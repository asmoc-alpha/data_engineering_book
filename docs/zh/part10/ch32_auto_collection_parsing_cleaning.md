...
![四源采集 Agent 统一架构](../../images/part10/Yu-Chap32-Fig01.svg)

图32-1展示了本节讨论对象的结构、流程或样例，便于对照正文理解关键环节。

*图 32-1：四源采集 Agent 统一架构*
...
![解析异常处理决策流程](../../images/part10/Yu-Chap32-Fig02.svg)

图32-2展示了本节讨论对象的结构、流程或样例，便于对照正文理解关键环节。
...
![质量过滤分级流水线](../../images/part10/Yu-Chap32-Fig03.svg)

图32-3展示了本节讨论对象的结构、流程或样例，便于对照正文理解关键环节。
